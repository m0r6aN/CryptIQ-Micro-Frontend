...
/*
# Deploy on local hardhat network with mainnet fork
npx hardhat deploy --tags FlashLoanArbitrage --network hardhat

# Deploy to mainnet
npx hardhat deploy --tags FlashLoanArbitrage --network mainnet

# Create new arbitrage contract
npx hardhat run scripts/create-arbitrage.ts --network mainnet
*/
