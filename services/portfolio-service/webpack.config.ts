// Example webpack.config.js for Module Federation setup for portfolioService
...
module.exports = {
  ...
  devServer: {
    ...
    port: 3007, // Port unique to portfolioService
  },
  output: {
    publicPath: 'auto',
  },
  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      exposes: {
        './PortfolioComponent': './src/components/PortfolioComponent',
